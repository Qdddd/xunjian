package com.yunwei.xunjian.myview;
	...
	Callback callback = new Callback() {
		...
		public void onViewReleased(View releasedChild, float xvel, float yvel) {
			...
			if (releasedChild == itemView) {
				...
				Log.d("xxxx","xvel == "+xvel+"   ;   math == "+itemView.getLeft()+"   ;   right == "+itemView.getRight()+"  ;  hiddenViewWidth == "+hiddenViewWidth+"  ;  /== "+hiddenViewWidth / 1.0f+"  offset== "+offset);
				if (xvel == 0
